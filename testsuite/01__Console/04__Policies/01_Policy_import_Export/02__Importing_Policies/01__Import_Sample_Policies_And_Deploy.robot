...
Force Tags        Import Sample Policies
Default Tags
...
*** Variables ***
${import_button}    //*[@id="cc-ps-main-content"]/div/div/div[1]/div[5]/button[2]    #import button from the policy list page
${Browse_Button}    //*[@id="import-file"]    # Browser Button from the popup screen

*** Test Cases ***
Importing_Sample_Policies
    ...
    sleep    2
    Choose File    ${Browse_Button}    ${DATA_DIR}\\sample policies.bin
    Click element    xpath=//button[@class="btn btn-default cc-btn-primary ng-binding"]
    sleep    10
    Wait Until Page Contains element    //*[@id="toast-container"]    #wait untill the page displays the imported polices list
    sleep    10
