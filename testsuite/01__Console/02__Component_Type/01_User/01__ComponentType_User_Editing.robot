...
*** Test Cases ***
User Subject Type Name Edit
    [Tags]    ComponentTypeSubject    ComponentTypeUser    Edit
    ...
    ${start_range}=    Set Variable    59    #Starting row from Excel worksheet to loop over.
    ${end_range}=    Set Variable    64    #Ending row from Excel worksheet + 1, e.g. end_range=21 refers to Excel row 20
